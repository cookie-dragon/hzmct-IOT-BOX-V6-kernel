...
static int da8xxfb_set_par(struct fb_info *info)
{
	...
	gpio_request(GPIO_TO_PIN(3, 5), "lcd backlight");
	gpio_direction_output(GPIO_TO_PIN(3, 5), 1);
...
static unsigned int da8xxfb_pixel_clk_period(struct da8xx_fb_par *par)
{
	...
	unsigned long long pix_clk_period_picosec = 1260000000000ULL;
