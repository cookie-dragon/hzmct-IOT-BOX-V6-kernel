...
{  
    ...
    err = snd_soc_add_controls(codec, evm_wm8960_controls,  
...
/******************** +++++ ******************************/
static struct snd_soc_dai_link am335x_evm_dk_dai = {
	.name = "WM8960",
	.stream_name = "WM8960",
	.cpu_dai_name = "davinci-mcasp.0",
...
/******************** +++++ ******************************/
static struct snd_soc_card am335x_evm_dk_snd_soc_card = {
	.name = "AM335X WM8960",
	.dai_link = &am335x_evm_dk_dai,
	.num_links = 1,
};
...
static int __init evm_init(void)
{
	...
	/*if (machine_is_davinci_evm()) {
		...
		evm_snd_dev_data = &am335x_evm_dk_snd_soc_card;
		index = 0;
	/*
#ifdef CONFIG_MACH_AM335XEVM
